# Testing-web-interfaces---Selenium [![Build status](https://ci.appveyor.com/api/projects/status/932byotxu8i3jcim?svg=true)](https://ci.appveyor.com/project/pelfegor/testing-web-interfaces-selenium)
